 ...
 * 
 */
public class GtRefreshableView extends LinearLayout {
		...
		touchView.setOnTouchListener(new View.OnTouchListener() {
			...
			public boolean onTouch(View arg0, MotionEvent event) {
				...
				if (currentStatus == STATUS_PULL_TO_REFRESH
					...
					// touchView.setFocusableInTouchMode(false);
	...
	private void setIsAbleToPull(MotionEvent event) {
		// View firstChild = touchView.getChildAt(0);
		// if (firstChild != null) {
		// int firstVisiblePos = touchView.getFirstVisiblePosition();
